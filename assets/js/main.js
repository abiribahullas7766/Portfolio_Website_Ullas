...
const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_vm709jo','template_v4mabqf','#contact-form','N_8u9ivWr4pbPw7iz')
    .then(() =>{
        //Show sent message
...
//we obtain the current theme that the interface has by validatiog the dark-theme class
